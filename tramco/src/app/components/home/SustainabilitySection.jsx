...
function SustainabilitySection() {
    return (
        <div className=" w-full h-auto relative overflow-hidden  bg-brand-blue xl:my-28 lg:my-16 justify-end  flex "  >
            ...
            ></div>
            <div className=" w-11/12  flex items-center  space-x-10">
            
                <div className=" pt-16 2xl:pt-24 2xl:pb-32 pb-24 space-y-8 flex w-[45%]  flex-col ">
                ...
                <div
                    className=" h-full w-[55%] group  p-2 shrink-0 z-0 relative bg-cover bg-no-repeat bg-center "
                    style={{ backgroundImage: "url('/image/home/island.png')" }}
                >
                    <div className="absolute group-hover:translate-y-0 translate-y-72 transition-all duration-1000 ease-in-out bottom-0 flex justify-center left-0 backdrop-blur-xl w-full h-20 xl:h-24 z-10 bg-[#0240A380]">
